...
const sendTutorData=(tutor)=>{
    ...
    return <div className="headDivtop">
        ...
        <p className="topheadedup"> Access to India's best {name} educators is just a subscription away</p>
        <p className="See">See all</p>
        <Swiper slidesPerView={2.3} spaceBetween={30} slidesPerGroup={2} loop={false} loopFillGroupWithBlank={true} pagination={{
  "clickable": true,
